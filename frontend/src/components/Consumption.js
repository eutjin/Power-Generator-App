      ...
      <Container size={1140} px={0}>
        <Card radius="md" shadow="md">
          ...
          >
            ...
            <div>
            <Text size="sm" color="dimmed" className={classes.modalText}>number of cities:</Text>
            <Text size="lg" >{metroNm.city}</Text>
            </div>
            <div>
            <Text size="sm" color="dimmed" className={classes.modalText}>no. of residence:</Text>
            <Text size="lg" >{(Math.round(metroNm.houseCnt)).toLocaleString()}</Text>
            </div>
            <div>
            <Text size="sm" color="dimmed" className={classes.modalText}>Daily Power Usage:</Text>
...
Consumption.js:192 convertion 경기도 */}
          ...
          {type == "map" ? (
            <div className={classes.container}>
              ...
              >
                <g class="layer" onClick={(e) => handelModal(e.target.id)}>
                  <title>Layer 1</title>
                  {/* gangwon2 */}
                  <path
