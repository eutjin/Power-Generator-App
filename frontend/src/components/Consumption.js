    ...
    <>
      <Container size={1140} px={0}>
        <Card radius="md" shadow="md">
          ...
          <Modal  centered size="70%" opened={consModal} onClose={()=>setConsModal(false)} title="modal">
         {inputs}
          
          <Text>current metro: {metroNm.metro}</Text>
          <Text>number of cities: {metroNm.city}</Text>
